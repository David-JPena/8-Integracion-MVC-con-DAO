...
public class Listar_producto extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("a_producto", lista);
		RequestDispatcher rd = request.getRequestDispatcher("listar_producto.jsp");

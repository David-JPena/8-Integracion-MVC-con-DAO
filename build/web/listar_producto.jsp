...
<jsp:useBean id="a_producto" class="java.util.ArrayList" scope="request"></jsp:useBean>
    <!DOCTYPE html>
    <html>
        <head>
            <meta charset="ISO-8859-1">
            <title>Lista de Productos | LIBRERÍA</title>
        ...
        <body class="">
            ...
            <div class=" container altura">
                <div>
                    <h2 class="text-center text-primary"><strong>Listado de Libros</strong></h2>
                    <hr>
                </div>
            </div>
            <div class="container mt-4 col-lg-6 border border-3 border-primary rounded-4">
                ...
                <%
                    ...
                    for (int i = 0; i < a_producto.size(); i++) {
                        pro = (Producto) a_producto.get(i);
                %>
